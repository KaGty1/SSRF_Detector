...
public class SettingsTab extends JPanel {
    ...
    private Component createExtensionsSettingUI(int rootX, int rootY) {
        ...
        JLabel globalSettingLabel = new JLabel("扫描流量配置");
        ...
        JLabel proxyCheckboxLabel = new JLabel("HTTP history");
        ...
        JLabel repeaterCheckboxLabel = new JLabel("Repeater扫描");
    ...
    private Component createThreadPoolSettingUI(int rootX, int rootY) {
        ...
        threadPoolSettingLabel.setBounds(rootX, rootY + 15, 200, 20);
    ...
    private Component createCacheSettingUI(int rootX, int rootY) {
        ...
        cacheSettingLabel.setBounds(rootX, rootY + 15, 200, 20);
    ...
    private void saveAllSettingUI(int rootX, int rootY) {
        ...
        saveAllSettingButton.setBounds(rootX, rootY + 15, 80, 20);
